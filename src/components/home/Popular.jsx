...
const Popular = () => {
    ...
    const filterDealOfTheDay=data.filter((item)=>item.popular == true);
  ...
  return (
    <div className='w-full md:w-11/12 mx-auto mt-10'>
        {/* banner */}
        <div 
  className="bg-cover bg-center h-48 flex  text-white px-10 py-10 " 
  style={{ backgroundImage: `url(${banner3})` }}
>
  <div className='text-white font-bold space-y-2'>
    <p className='text-sm'>All Products</p>
    <h3 className='text-3xl'>Free Shipping on over $50</h3>
    <button className='bg-[#019267] px-3 py-2 rounded text-sm'>See More Products</button>
  </div>
</div>
{/* slider */}
    <div className="block md:flex  justify-center   gap-4 p-4 space-y-8 md:space-y-0 mt-20">
      ...
      <div className='flex items-center gap-10'>
        <h1 className='md:font-bold text-sm md:text-xl'>Our Popular Products</h1>
